<div class="hairColours view">
<h2><?php echo __('Hair Colour'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($hairColour['HairColour']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Colour'); ?></dt>
		<dd>
			<?php echo h($hairColour['HairColour']['colour']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Hair Colour'), array('action' => 'edit', $hairColour['HairColour']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Hair Colour'), array('action' => 'delete', $hairColour['HairColour']['id']), null, __('Are you sure you want to delete # %s?', $hairColour['HairColour']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($hairColour['Extra'] as $extra): ?>
		<tr>
