...
<?php echo $this->Form->create('HairColour'); ?>
	<fieldset>
		<legend><?php echo __('Edit Hair Colour'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('HairColour.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('HairColour.id'))); ?></li>
