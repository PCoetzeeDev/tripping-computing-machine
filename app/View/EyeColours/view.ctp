<div class="eyeColours view">
<h2><?php echo __('Eye Colour'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($eyeColour['EyeColour']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Colour'); ?></dt>
		<dd>
			<?php echo h($eyeColour['EyeColour']['colour']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Eye Colour'), array('action' => 'edit', $eyeColour['EyeColour']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Eye Colour'), array('action' => 'delete', $eyeColour['EyeColour']['id']), null, __('Are you sure you want to delete # %s?', $eyeColour['EyeColour']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($eyeColour['Extra'] as $extra): ?>
		<tr>
